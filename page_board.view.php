<div class="wrap">
	...
	<div class="kanpress-container tres-col">
		...
		<div class="" id="col4">
			<h3><?php _e('Status_cat4', 'kanpress') ?> <span></span></h3>
			<div class="tasks-area">
				<?php foreach ($tasks_status_4 as $task) : ?>
				<?php kanpress_html_task($task, $categories) ?>
				<?php endforeach ?>
			</div>
		</div>
		<div class="" id="col5">
			<h3><?php _e('Status_cat5', 'kanpress') ?> <span></span></h3>
			<div class="tasks-area">
				<?php foreach ($tasks_status_5 as $task) : ?>
				<?php kanpress_html_task($task, $categories) ?>
				<?php endforeach ?>
			</div>
		</div>
